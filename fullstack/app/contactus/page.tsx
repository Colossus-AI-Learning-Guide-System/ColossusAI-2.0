        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="mb-6 text-white/80">Have any questions? We'd love to hear from you.</p>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg bg-black/30 border-2 ${errors.name ? 'border-red-500' : 'border-white/20'} text-white focus:outline-none focus:border-blue-500 transition-colors`}
                />
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg bg-black/30 border-2 ${errors.email ? 'border-red-500' : 'border-white/20'} text-white focus:outline-none focus:border-blue-500 transition-colors`}
                />
              ...
              {/* Subject Input */}
              <div className="mb-6">
                <label className="block text-white text-lg mb-2">Subject</label>
                <input
                  type="text"
                  ...
                  className={`w-full px-4 py-3 rounded-lg bg-black/30 border-2 ${errors.subject ? 'border-red-500' : 'border-white/20'} text-white focus:outline-none focus:border-blue-500 transition-colors`}
                />
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 rounded-lg bg-black/30 border-2 ${errors.message ? 'border-red-500' : 'border-white/20'} text-white focus:outline-none focus:border-blue-500 transition-colors h-32`}
